...
_sorting:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  2b:	89 e1                	mov    %esp,%ecx
  2d:	89 c2                	mov    %eax,%edx
  2f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  34:	83 e2 f0             	and    $0xfffffff0,%edx
  37:	29 c1                	sub    %eax,%ecx
  39:	39 cc                	cmp    %ecx,%esp
  3b:	74 23                	je     60 <main+0x60>
  3d:	81 ec 00 10 00 00    	sub    $0x1000,%esp
  43:	83 8c 24 fc 0f 00 00 	orl    $0x0,0xffc(%esp)
  4a:	00 
  4b:	eb ec                	jmp    39 <main+0x39>
        printf(1,"Error: No Args Provided");
  4d:	50                   	push   %eax
  4e:	50                   	push   %eax
  4f:	68 7c 08 00 00       	push   $0x87c
  54:	6a 01                	push   $0x1
  56:	e8 f5 04 00 00       	call   550 <printf>
        exit(); 
  5b:	e8 73 03 00 00       	call   3d3 <exit>
    int arr[n];
  60:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
  66:	29 d4                	sub    %edx,%esp
  68:	85 d2                	test   %edx,%edx
  6a:	75 46                	jne    b2 <main+0xb2>
  6c:	89 e6                	mov    %esp,%esi
    
    for (int i = 0; i < n; i++) {
  6e:	31 ff                	xor    %edi,%edi
        arr[i] = atoi(argv[i + 1]);
  70:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  73:	83 ec 0c             	sub    $0xc,%esp
  76:	ff 74 b8 04          	push   0x4(%eax,%edi,4)
  7a:	e8 e1 02 00 00       	call   360 <atoi>
    for (int i = 0; i < n; i++) {
  ...
  8f:	53                   	push   %ebx
  90:	56                   	push   %esi
  91:	e8 4a 00 00 00       	call   e0 <bubbleSort>
    printf(1,"Sorted array: \n");
  96:	58                   	pop    %eax
  97:	5a                   	pop    %edx
  98:	68 94 08 00 00       	push   $0x894
  9d:	6a 01                	push   $0x1
  9f:	e8 ac 04 00 00       	call   550 <printf>
    printArray(arr, n);
  a4:	59                   	pop    %ecx
  a5:	5f                   	pop    %edi
  a6:	53                   	push   %ebx
  a7:	56                   	push   %esi
  a8:	e8 83 00 00 00       	call   130 <printArray>
    exit();
  ad:	e8 21 03 00 00       	call   3d3 <exit>
    int arr[n];
  b2:	83 4c 14 fc 00       	orl    $0x0,-0x4(%esp,%edx,1)
  b7:	eb b3                	jmp    6c <main+0x6c>
  b9:	66 90                	xchg   %ax,%ax
  bb:	66 90                	xchg   %ax,%ax
  bd:	66 90                	xchg   %ax,%ax
  bf:	90                   	nop
...
void swap(int* a, int* b) {
  ...
  ca:	8b 0a                	mov    (%edx),%ecx
    *a = *b;
  cc:	8b 18                	mov    (%eax),%ebx
  ce:	89 1a                	mov    %ebx,(%edx)
    *b = temp;
  d0:	89 08                	mov    %ecx,(%eax)
}
...
void bubbleSort(int arr[], int n) {
  ...
  eb:	53                   	push   %ebx
    for (i = 0; i < n - 1; i++)        
  ec:	8d 70 ff             	lea    -0x1(%eax),%esi
  ef:	85 f6                	test   %esi,%esi
  f1:	7e 32                	jle    125 <bubbleSort+0x45>
  f3:	8d 5c 87 fc          	lea    -0x4(%edi,%eax,4),%ebx
  f7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  fe:	66 90                	xchg   %ax,%ax
void bubbleSort(int arr[], int n) {
 100:	89 f8                	mov    %edi,%eax
 102:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            if (arr[j] > arr[j + 1])
 108:	8b 10                	mov    (%eax),%edx
 10a:	8b 48 04             	mov    0x4(%eax),%ecx
 10d:	39 ca                	cmp    %ecx,%edx
 10f:	7e 05                	jle    116 <bubbleSort+0x36>
    *a = *b;
 111:	89 08                	mov    %ecx,(%eax)
    *b = temp;
 113:	89 50 04             	mov    %edx,0x4(%eax)
        for (j = 0; j < n - i - 1; j++)  
 116:	83 c0 04             	add    $0x4,%eax
 119:	39 d8                	cmp    %ebx,%eax
 11b:	75 eb                	jne    108 <bubbleSort+0x28>
    for (i = 0; i < n - 1; i++)        
 11d:	83 eb 04             	sub    $0x4,%ebx
 120:	83 ee 01             	sub    $0x1,%esi
 123:	75 db                	jne    100 <bubbleSort+0x20>
}
 125:	5b                   	pop    %ebx
 126:	5e                   	pop    %esi
 127:	5f                   	pop    %edi
...
void printArray(int arr[], int size) {
 ...
 139:	8b 75 0c             	mov    0xc(%ebp),%esi
 13c:	8b 7d 08             	mov    0x8(%ebp),%edi
    for (i = 0; i < size; i++)
 13f:	85 f6                	test   %esi,%esi
 141:	7e 21                	jle    164 <printArray+0x34>
 143:	31 db                	xor    %ebx,%ebx
 145:	8d 76 00             	lea    0x0(%esi),%esi
        printf(1, "%d ", arr[i]);
 148:	83 ec 04             	sub    $0x4,%esp
 14b:	ff 34 9f             	push   (%edi,%ebx,4)
    for (i = 0; i < size; i++)
 14e:	83 c3 01             	add    $0x1,%ebx
        printf(1, "%d ", arr[i]);
 151:	68 78 08 00 00       	push   $0x878
 156:	6a 01                	push   $0x1
 158:	e8 f3 03 00 00       	call   550 <printf>
    for (i = 0; i < size; i++)
 15d:	83 c4 10             	add    $0x10,%esp
 160:	39 de                	cmp    %ebx,%esi
 162:	75 e4                	jne    148 <printArray+0x18>
    printf(1, "\n"); 
 164:	c7 45 0c a2 08 00 00 	movl   $0x8a2,0xc(%ebp)
 16b:	c7 45 08 01 00 00 00 	movl   $0x1,0x8(%ebp)
}
 ...
 178:	5d                   	pop    %ebp
    printf(1, "\n"); 
 179:	e9 d2 03 00 00       	jmp    550 <printf>
 ...
 4ac:	89 d1                	mov    %edx,%ecx
{
 ...
 4d9:	0f b6 92 04 09 00 00 	movzbl 0x904(%edx),%edx
 ...
 559:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c9:	ff 24 85 ac 08 00 00 	jmp    *0x8ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6d7:	90                   	nop
          s = "(null)";
 6d8:	ba a4 08 00 00       	mov    $0x8a4,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6f1:	a1 34 0c 00 00       	mov    0xc34,%eax
{
 ...
 731:	5b                   	pop    %ebx
  freep = p;
 732:	89 15 34 0c 00 00    	mov    %edx,0xc34
}
 738:	5e                   	pop    %esi
 739:	5f                   	pop    %edi
 73a:	5d                   	pop    %ebp
 ...
 769:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 76c:	89 15 34 0c 00 00    	mov    %edx,0xc34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 789:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 78c:	8b 3d 34 0c 00 00    	mov    0xc34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7cf:	73 4f                	jae    820 <malloc+0xa0>
    ...
    if(p == freep)
 7d1:	8b 3d 34 0c 00 00    	mov    0xc34,%edi
 ...
 7fa:	e8 f1 fe ff ff       	call   6f0 <free>
  return freep;
 7ff:	8b 15 34 0c 00 00    	mov    0xc34,%edx
 ...
 82c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 82f:	89 15 34 0c 00 00    	mov    %edx,0xc34
}
 ...
 83f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 34 0c 00 00 38 	movl   $0xc38,0xc34
 847:	0c 00 00 
    base.s.size = 0;
 84a:	bf 38 0c 00 00       	mov    $0xc38,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 38 0c 00 00 38 	movl   $0xc38,0xc38
 856:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 85b:	c7 05 3c 0c 00 00 00 	movl   $0x0,0xc3c
 862:	00 00 00 
    if(p->s.size >= nunits){
