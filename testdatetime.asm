...
_testdatetime:     file format elf32-i386
...
main (int argc, char * argv[]) {
  ...
  16:	50                   	push   %eax
  17:	50                   	push   %eax
  18:	68 b1 07 00 00       	push   $0x7b1
  1d:	6a 01                	push   $0x1
  1f:	e8 3c 04 00 00       	call   460 <printf>
    exit();
  24:	e8 ba 02 00 00       	call   2e3 <exit>
  }
  testDateTime();
  29:	e8 12 00 00 00       	call   40 <testDateTime>
  exit();
  2e:	e8 b0 02 00 00       	call   2e3 <exit>
  33:	66 90                	xchg   %ax,%ax
  35:	66 90                	xchg   %ax,%ax
  37:	66 90                	xchg   %ax,%ax
  39:	66 90                	xchg   %ax,%ax
...
00000040 <testDateTime>:
testDateTime(){
  40:	55                   	push   %ebp
  41:	89 e5                	mov    %esp,%ebp
  43:	83 ec 34             	sub    $0x34,%esp
    if (datetime(&r)){
  46:	8d 45 e0             	lea    -0x20(%ebp),%eax
  49:	50                   	push   %eax
  4a:	e8 34 03 00 00       	call   383 <datetime>
  4f:	83 c4 10             	add    $0x10,%esp
  52:	85 c0                	test   %eax,%eax
  54:	75 23                	jne    79 <testDateTime+0x39>
    printf(1, "Today is %d-%d-%d %d:%d:%d\n", r.year, r.month, r.day, r.hour, r.minute, r.second);
  56:	ff 75 e0             	push   -0x20(%ebp)
  59:	ff 75 e4             	push   -0x1c(%ebp)
  5c:	ff 75 e8             	push   -0x18(%ebp)
  5f:	ff 75 ec             	push   -0x14(%ebp)
  62:	ff 75 f0             	push   -0x10(%ebp)
  65:	ff 75 f4             	push   -0xc(%ebp)
  68:	68 95 07 00 00       	push   $0x795
  6d:	6a 01                	push   $0x1
