...
_getparent:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  26:	e8 28 03 00 00       	call   353 <getparentpid>
  2b:	83 c4 0c             	add    $0xc,%esp
  2e:	50                   	push   %eax
  2f:	68 49 07 00 00       	push   $0x749
  34:	6a 01                	push   $0x1
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 598:	ba 59 07 00 00       	mov    $0x759,%edx
        s = (char*)*ap;
