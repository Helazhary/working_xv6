...
int main(void) {
  ...
  13:	51                   	push   %ecx
    ...
    for (i = 0; i < children; i++) {
        int pid = fork();
  14:	e8 a2 02 00 00       	call   2bb <fork>
        if (pid == 0) { //just checks if succesfully forked
  19:	85 c0                	test   %eax,%eax
  1b:	74 42                	je     5f <main+0x5f>
    for (i = 0; i < children; i++) {
  ...
  25:	6a 64                	push   $0x64
  27:	e8 27 03 00 00       	call   353 <sleep>
    printf(1, "Zombie Count = %d\n", getzombcount());
  2c:	e8 42 03 00 00       	call   373 <getzombcount>
  ...
  46:	e8 80 02 00 00       	call   2cb <wait>
  4b:	e8 7b 02 00 00       	call   2cb <wait>
  50:	e8 76 02 00 00       	call   2cb <wait>
  55:	e8 71 02 00 00       	call   2cb <wait>
    }
