...
_getzombcount:     file format elf32-i386
...
int main(void) {
  ...
  11:	e8 1d 03 00 00       	call   333 <getzombcount>
 ...
 409:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 479:	ff 24 85 4c 07 00 00 	jmp    *0x74c(,%eax,4)
 ...
 588:	ba 44 07 00 00       	mov    $0x744,%edx
        s = (char*)*ap;
 ...
 5a1:	a1 4c 0a 00 00       	mov    0xa4c,%eax
{
 ...
 619:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 61c:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 3d 4c 0a 00 00    	mov    0xa4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 67f:	73 4f                	jae    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 681:	8b 3d 4c 0a 00 00    	mov    0xa4c,%edi
 ...
 6aa:	e8 f1 fe ff ff       	call   5a0 <free>
  return freep;
 6af:	8b 15 4c 0a 00 00    	mov    0xa4c,%edx
 ...
 6dc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6df:	89 15 4c 0a 00 00    	mov    %edx,0xa4c
}
 ...
 6ef:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 4c 0a 00 00 50 	movl   $0xa50,0xa4c
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	bf 50 0a 00 00       	mov    $0xa50,%edi
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 50 0a 00 00 50 	movl   $0xa50,0xa50
 706:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 709:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 70b:	c7 05 54 0a 00 00 00 	movl   $0x0,0xa54
 712:	00 00 00 
    if(p->s.size >= nunits){
